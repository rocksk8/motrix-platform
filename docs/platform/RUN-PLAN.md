...
- **列車月台**（PLAYBOOK §G3；各線登記：分支｜HEAD｜差異題結果｜是否動 fixture 層／main）：
  ...
  - H｜`wip/h-u15-2`（取代 h-u15：rebase 到第七班 2f039d43；U15 使用者表單＋D 稽核 M-1／S-1／S-2／O-1 已關閉＋O-2（custom 名單也算收件人）、V5）｜134328be｜U15 9 題＋相關與產生檔守門（-n 4）332 過；突變各紅｜動 L1 routers/auth.py、mail_settings.py｜O-2 待 D 以 range-diff 複核〔2026-09-26 13:58 H〕
