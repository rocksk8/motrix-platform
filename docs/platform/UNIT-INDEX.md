...
| `core:db` | L1 | DB connection factory, schema initialisation, and numbered migrations.（無單位卡） | 28 | 61 | — |
...
| `helper:settings` | L1 | System settings CRUD (system_settings table).（無單位卡） | 2 | 32 | — |
