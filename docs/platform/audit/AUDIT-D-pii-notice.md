...
|---|---|---|---|
| PN-M1 | 〔主持裁示 2026-09-26，CORE-SPEC 7eb5198f〕告知以**欄位與當事人**為單位決定，不以頁為單位；出貨單收件人與送貨地址可手動輸入 ⇒ 要告知（用途同聯絡人）。交給 A（出貨模組擁有者），排在 M03 之後 | 7eb5198f（裁示） | 未關：待 A 修正後 D 確認（pii_forms.json 逐欄＋收件人告知＋notice 頁多一欄即紅的反向控制） |
| PN-S1～S3 | | | |
| O-1～O-4 | | | |
