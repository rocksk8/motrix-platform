...
;(function () {
  ...
  function buildSidebar() {
    var html = [
      ...
      ni(pg('vendor-contractors.html'), 'vend',  '承攬商管理', ['vendor-contractors.html'],               cPr),
      ...
      ni(pg('warranty.html'),        'warr',  '保固追蹤', ['warranty.html'], cEq),
      sec('財務', cFi),
      ni(pg('receivables.html'),     'recv',  '應收帳款', ['receivables.html'],                      cFi,  'sb-mod-finance'),
      ni(pg('sales-orders.html'),    'order', '銷售訂單', ['sales-orders.html'],                     cFi),
