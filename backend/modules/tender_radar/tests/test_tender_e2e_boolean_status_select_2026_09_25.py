"""（自 tests/test_e2e_boolean_status_select_2026_09_25.py 拆出，2026-09-25）「狀態」下拉（啟用／停用）必須真的存得進 false，停用的資料打開也要顯示停用。
...
from tests._mapiso import no_tile_probe  # noqa: E402,F401  （tender-radar 會載地圖 ⇒ 後端探測底圖伺服器）
