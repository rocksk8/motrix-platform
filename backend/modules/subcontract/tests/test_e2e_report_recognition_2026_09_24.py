...
（2026-09-26 自 tests/test_e2e_report_recognition_2026_09_24.py 拆出：這幾題需要本模組在，隨模組搬走。原檔的說明：）
...
@pytest.mark.e2e
def test_case_page_stage_ratio_and_dispatch_invoice_date_land(live_server, make_user, e2e_browser):
    _case("MQ-RBE-010")
