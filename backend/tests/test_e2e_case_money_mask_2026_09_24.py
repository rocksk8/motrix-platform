...
@pytest.mark.e2e
def test_engineer_edits_payment_note_and_amounts_survive(live_server, make_user, e2e_browser):
...
@pytest.mark.e2e
def test_financial_user_still_sees_amount_inputs(live_server, make_user, e2e_browser):
