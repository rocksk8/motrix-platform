...
@pytest.mark.e2e
def test_section_titles_say_how_they_save(live_server, make_user):
...
@pytest.mark.e2e
def test_auto_save_flashes_a_tick_only_after_the_server_says_ok(live_server, make_user):
...
@pytest.mark.e2e
def test_labels_point_at_real_fields_and_ticking_received_prompts_for_the_date(live_server, make_user):
