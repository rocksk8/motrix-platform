...
_BASELINE_COUNT = 137   # 2026-09-25：只算 modules/ 以外（M11 的 6 條由 modules/tender_radar/tests/ 自己釘）
#: 〔2026-09-26 M01 ②：139 → 137。M01 的 router 搬進 modules/case/api/，其中 2 條隨之移出掃描範圍；
#:   同一個掃描器含 modules/ 的總數搬遷前（b3b3b9aa）後都是 157 ⇒ 沒有任何一句被刪，只是換了位置〕
