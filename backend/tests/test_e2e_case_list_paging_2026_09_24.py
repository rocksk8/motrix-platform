...
@pytest.mark.e2e
def test_first_page_then_load_more(live_server, make_user):
...
@pytest.mark.e2e
def test_search_reaches_cases_outside_the_loaded_page(live_server, make_user):
...
@pytest.mark.e2e
def test_deep_link_opens_a_case_outside_the_first_page(live_server, make_user):
