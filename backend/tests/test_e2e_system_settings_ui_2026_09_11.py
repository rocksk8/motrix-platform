...
@pytest.mark.e2e
def test_all_four_cards_render_for_superadmin(live_server, make_user, e2e_browser):
...
@pytest.mark.e2e
def test_backup_retention_round_trip(live_server, make_user, e2e_browser):
...
@pytest.mark.e2e
def test_retention_out_of_range_is_blocked_with_field_name(live_server, make_user, e2e_browser):
...
@pytest.mark.e2e
def test_s3_fields_appear_only_when_s3_selected(live_server, make_user, e2e_browser):
