...
@pytest.mark.e2e
def test_quote_no_search_is_case_insensitive(live_server, make_user):
...
@pytest.mark.e2e
def test_case_link_carries_quote_no(live_server, make_user):
...
@pytest.mark.e2e
def test_list_filters_survive_returning_to_list(live_server, make_user):
...
@pytest.mark.e2e
def test_tab_and_status_labels_explain_themselves(live_server, make_user):
...
@pytest.mark.e2e
def test_keyboard_insert_and_move_items(live_server, make_user):
