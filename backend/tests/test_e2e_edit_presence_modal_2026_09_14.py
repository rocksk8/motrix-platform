...
@pytest.mark.e2e
def test_modal_pops_for_second_editor(live_server, make_user, e2e_browser):
...
@pytest.mark.e2e
def test_modal_pops_when_someone_joins_midway(live_server, make_user, e2e_browser):
...
@pytest.mark.e2e
def test_no_modal_for_single_editor(live_server, make_user, e2e_browser):
