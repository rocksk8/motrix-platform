...
from tests.test_e2e_case_concurrent_edit_2026_09_24 import _login, live_server  # noqa: F401
from tests.test_contractor_bank_branch_2026_09_24 import _add_contractor, _contractor, _seed_voucher, _xlsx


@pytest.mark.e2e
def test_roster_list_shows_branch_and_import_reports_result(live_server, make_user, tmp_path):
...
@pytest.mark.e2e
def test_approval_queue_voucher_shows_each_personnel_bank(live_server, make_user):
