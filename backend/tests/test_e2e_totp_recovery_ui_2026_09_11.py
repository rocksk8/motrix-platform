...
@pytest.mark.e2e
def test_recovery_remaining_and_regenerate_flow(live_server, make_user, e2e_browser):
...
@pytest.mark.e2e
def test_low_remaining_shows_warning(live_server, make_user, e2e_browser):
