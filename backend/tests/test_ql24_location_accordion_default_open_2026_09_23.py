...
@pytest.mark.e2e
def test_ql24_an_empty_location_is_open_by_default(live_server, make_user, e2e_browser):
...
@pytest.mark.e2e
def test_ql24_a_filled_location_stays_open_by_default(live_server, make_user, e2e_browser):
...
@pytest.mark.e2e
def test_ql24_manually_collapsing_it_still_works(live_server, make_user, e2e_browser):
