...
ALLOWED = {
    ...
    ("routers/bonus.py", "submit_case_bonus"): "同上",
    ("routers/bonus.py", "approve_case_bonus"): "同上",
    ("routers/bonus.py", "reject_case_bonus"): "同上",
    ("routers/bonus.py", "return_case_bonus"): "同上",
    ("routers/bonus.py", "mark_case_bonus_paid"): "同上",
